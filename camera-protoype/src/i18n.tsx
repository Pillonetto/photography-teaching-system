...
const TRANSLATIONS: Record<AppLocale, I18nCopy> = {
  ...
  'pt-BR': {
    ...
    serverError: 'Não foi possível conectar ao servidor. Ele está em execução?',
    profileProgressTitle: 'Seu progresso',
    profileDone: 'Concluir',
    profilePhotographer: 'Fotógrafo(a)',
    profileMilestonePath: 'Trilha de marcos',
    profileSkills: 'Suas habilidades',
    profileLevelsHint: 'Os níveis sobem cada vez que você envia uma foto forte nessa habilidade.',
    interviewTitle: 'Conhecendo você',
    ...
    teachingIntentPlaceholder: 'O que você queria alcançar com esta foto? (opcional)',
    teachingSubmitForFeedback: 'Enviar para feedback',
    teachingAnalysingPhoto: 'Analisando sua foto...',
    teachingFeedback: 'Feedback',
    teachingMilestoneReached: (milestone) => `Marco alcançado: ${milestone}!`,
